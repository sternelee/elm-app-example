...
var author$project$Main$NewGif = function (a) {
	return {$: 'NewGif', a: a};
};
...
var author$project$Main$getRandomGif = function (topic) {
	return A2(
		elm$http$Http$send,
		author$project$Main$NewGif,
		A2(
			elm$http$Http$get,
			author$project$Main$toGiphyUrl(topic),
			author$project$Main$gifDecoder));
};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		A2(author$project$Main$Model, 'cat', 'waiting.gif'),
		author$project$Main$getRandomGif('cat'));
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'MorePlease') {
			return _Utils_Tuple2(
				model,
				author$project$Main$getRandomGif(model.topic));
		} else {
			var result = msg.a;
			if (result.$ === 'Ok') {
				var newUrl = result.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(model.topic)
					])),
				A2(
